...
## Education
* BSc in Automation, Shenzhen University, 2025(Expected)

## Coursework
* Electrical courses: Applied Electronics (A+), Microcontroller Principles and Interface Technology (A), Sensor and Detection Technology (A), Signal and System (A), Pattern Recognition (A)
* Robotics and Control courses: Robotics and Control (A+), Control System Simulation (A+), Automatic Control Theory (A), Computer Control Technology (A), Robot Operation system (A)
